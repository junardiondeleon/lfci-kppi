      ...
      <tbody>
        ...
        <?php if (count($groups)): ?>
          ...
          <?php foreach ($groups as $group): ?>
            <tr <?php echo $this->session->flashdata('t_id') == $group->group_id ? "class='success'" : ''; ?> >
              ...
              <td>
                 <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="<?php echo base_url() . 'group/'. $group->group_id . '/edit'; ?>">Edit</a></li>

                   
                    
                    <li><a href="<?php echo base_url() . 'group/'. $group->group_id . '/view'; ?>">View</a></li>
                   
                    <li><a href="<?php echo base_url() . 'group/'. $group->group_id . '/delete'; ?>" onclick="return confirm('You are about to delete a record. This is cannot be undone. Are you sure?');">Delete</a></li>
