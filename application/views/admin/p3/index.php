              ...
              <td>
                 ...
                 <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <?php if($member_loan->finalized_by < 1): ?>
                    <li><a href="<?php echo base_url() . 'p3/'. $member_loan->member_loan_id . '/edit'; ?>">Edit</a></li>
                    <?php endif; ?>
                    <li><a href="<?php echo base_url() . 'p3/'. $member_loan->member_loan_id . '/view'; ?>">View</a></li>
                    <li><a href="<?php echo base_url() . 'p3/'. $member_loan->member_loan_id . '/add_comment'; ?>">Add Comment</a></li>
                    <?php if($member_loan->finalized_by < 1): ?>
                    <li><a href="<?php echo base_url() . 'p3/'. $member_loan->member_loan_id . '/delete'; ?>" onclick="return confirm('You are about to delete a record. This is cannot be undone. Are you sure?');">Delete</a></li>
                    <?php endif; ?>
                  </ul>
                </div>
