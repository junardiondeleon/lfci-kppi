...
<div class="alert alert-info alert-dismissible">
    ...
    <h4><i class="icon fa fa-question-circle"></i> Are you sure you want to finalize this loan application? Please review the loan application. This action is undoable.</h4>
    <?php echo $form_url; ?>
    <button type="submit" class="btn btn-primary" name="btn_final" value="Yes">Yes</button>
    <a href="<?php echo site_url('p3')?>" class="btn btn-default">No</a>
...
<div class="box box-default">
  ...
  <div class="box-body" style="">
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="loan_collaterals">Loan Collateral Type</label>
      <textarea id="loan_collaterals" readonly name="loan_collaterals" class="form-control" rows="3" placeholder="Remarks"><?php echo set_value('loan_collaterals', $member_loan->loan_collaterals);?></textarea>
      </div>
    
    
    <div class="form-group">
          <label for="loan_collateral_details">Loan Collateral Details</label>
           <textarea id="loan_collateral_details" readonly name="loan_collateral_details" class="form-control" rows="6" placeholder="Remarks"><?php echo set_value('loan_collateral_details', strip_tags($member_loan->loan_collateral_details)); ?></textarea>
        </div>
        </div>
    </div>
  </div>
...
<div class="box box-default">
  ...
  <div class="box-body" style="">
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <input type="text" name="collector_name" id="collector_name" readonly class="form-control" value="<?php echo set_value('collector_name', $member_loan->collector_name);?>">
        </div>
      </div>
   </div>
 </div>    
...
<div class="box-footer">
      ...
      <a href="<?php echo site_url('p3/index')?>" class="btn btn-default btn-lg">Back</a>
