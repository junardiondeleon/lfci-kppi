      ...
      <?php echo $form_url; ?>
        <div class="box-body">
          <div class="form-group">
            ...
            <?php $search_fields = array('loan_program_name'=>'Loan Program', 'loan_term'=>'Loan Term'); ?>
  ...
  <div class="col-md-9">
    ...
    <div class="box">
      ...
      <tbody>
        ...
        <?php if (count($loan_terms)): ?>
          <?php $counter = $record_no; ?>
          <?php foreach ($loan_terms as $loan_term): ?>
            <tr <?php echo $this->session->flashdata('t_id') == $loan_term->loan_term_id ? "class='success'" : ''; ?> >
              <td><?php echo ++$counter;?></td>
              <td><?php echo $loan_term->loan_program_name; ?></td>
              <td><?php echo $loan_term->loan_term;?></td>
              <td><?php echo $loan_term->interest; ?></td>
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo base_url() . 'loan_term/'. $loan_term->loan_term_id . '/edit'; ?>">Edit</a></li>
                    <li><a href="<?php echo base_url() . 'loan_term/'. $loan_term->loan_term_id . '/view'; ?>">View</a></li>
                    <li><a href="<?php echo base_url() . 'loan_term/'. $loan_term->loan_term_id . '/delete'; ?>" onclick="return confirm('You are about to delete a record. This is cannot be undone. Are you sure?');">Delete</a></li>
