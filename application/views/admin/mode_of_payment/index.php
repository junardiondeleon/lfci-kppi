      ...
      <?php echo $form_url; ?>
        <div class="box-body">
          <div class="form-group">
            ...
            <?php $search_fields = array('mode_of_payment'=>'Mode of Payment'); ?>
  ...
  <div class="col-md-9">
    ...
    <div class="box">
      ...
      <tbody>
        ...
        <?php if (count($mode_of_payments)): ?>
          <?php $counter = $record_no; ?>
          <?php foreach ($mode_of_payments as $mode_of_payment): ?>
            <tr <?php echo $this->session->flashdata('t_id') == $mode_of_payment->mode_of_payment_id ? "class='success'" : ''; ?> >
              <td><?php echo ++$counter;?></td>
              <td><?php echo $mode_of_payment->loan_program_name; ?></td>
              <td><?php echo $mode_of_payment->mode_of_payment;?></td>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo base_url() . 'mode_of_payment/'. $mode_of_payment->mode_of_payment_id . '/edit'; ?>">Edit</a></li>
                    <li><a href="<?php echo base_url() . 'mode_of_payment/'. $mode_of_payment->mode_of_payment_id . '/view'; ?>">View</a></li>
                    <li><a href="<?php echo base_url() . 'mode_of_payment/'. $mode_of_payment->mode_of_payment_id . '/delete'; ?>" onclick="return confirm('You are about to delete a record. This is cannot be undone. Are you sure?');">Delete</a></li>
