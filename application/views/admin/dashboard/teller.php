<div class="row">
	    ...
	    <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?php echo base_url(); ?>p3" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green">
            ...
            <a href="<?php echo base_url(); ?>p3/approved_loans" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo base_url(); ?>p3/disapproved_loans" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
...
<div class="row">
	<div class="col-lg-6 col-xs-6">
      ...
      <div class="box-header">
        <h3 class="box-title">Latest Loans Application</h3>
        ...
        <?php if (count($member_loans)): ?>
          ...
          <?php foreach ($member_loans as $member_loan): ?>
            <tr <?php echo $this->session->flashdata('t_id') == $member_loan->member_loan_id ? "class='success'" : ''; ?> >
              ...
              <td>
                   <div class="btn-group">
                  <a href="<?php echo base_url() . 'p3/'. $member_loan->member_loan_id . '/view'; ?>" class="btn btn-default btn-flat">View</a>
